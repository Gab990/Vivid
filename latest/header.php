...
<head>
    ...
    <meta name="title" content="Vivid VR social platform">
    <meta name="description" content="Vivid is a University social media platform that aims to deliver a vr experience">
    <meta name="keywords" content="social media, VR, share, add, friends, messages, chat, photos">
    ...
    <div class="container-fluid">
        ...
        <div class="top_bar row-fluid">
            <div class="logo col-md-1">
                <a style="margin:0;padding:0" href="index.php"><img width="45" height="45" style="padding-top:2px;padding-left:25px;" src="assets/images/icons/logo.png"></a>
            </div>
...
<a href="<?php echo $userLoggedIn; ?>" id="myProfile">
...
<a href="index.php" id="homePage" class="navelement">

<i class="fa fa-home fa-lg"></i>

</a>

<a href="javascript:void(0);" onclick="getDropdownData('<?php echo $userLoggedIn; ?>', 'message')" id="inbox" class="navelement">
...
<a href="javascript:void(0);" onclick="getDropdownData('<?php echo $userLoggedIn; ?>', 'notification')" id="notif" class="navelement">
...
<a href="requests.php" class="navelement" id="requests">
...
<a href="settings.php" class="navelement" id="settings">
<i class="fa fa-cog fa-lg"></i>


</a>

<a href="includes/handlers/logout.php" class="navelement" id="logout">
...
if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
  ...
  bg.src="assets/images/backgrounds/bg.gif";
}else{
  // false for not mobile device
  bg.src="assets/images/backgrounds/bgmob.gif"
}
</script>
        ...
        <div class="wrapper">
            ...
            <div class="chat_box" onclick="getDropdownData('<?php echo $userLoggedIn; ?>', 'message2')">
                <a href="messages.php">
                    <h4 id="messagetitle">Messages</h4>
                </a>
            ...
            <script>
                ...
                const checkNotifications = () => {
                    ...
                    $.post("includes/handlers/check_notifs.php", {
                        user: userLoggedIn
                    }, function(data) {

                        if (data)
                            $("a#notif").append(`<span class="notification_badge" id="unread_notification">${data}</span>`);
                            // if(data>0){notifyMe();}
                    });
                }
                ...
                const checkMessages = () => {
                    ...
                    $.post("includes/handlers/check_mess.php", { 
                        user: userLoggedIn
                    }, function(data) {

                        if (data)
                            $("a#inbox").append(`<span class="notification_badge" id="unread_message">${data}</span>`);
                            // if(data>0){notifyMe();}
                    });
                }
                ...
                const checkRequests = () => {
                    ...
                    $.post("includes/handlers/check_requests.php", {
                        user: userLoggedIn
                    }, function(data) {

                        if (data)
                            $("a#requests").append(`<span class="notification_badge" id="unread_requests">${data}</span>`);
                            // if(data>0){notifyMe();}
                    });
                }

                setInterval(checkRequests, 20000);
