...
//query holds the search results
$query = $_POST['query'];
$userLoggedIn = $_POST['userLoggedIn'];

//splits up the array at the spaces - able to search for first and last names
$names = explode(" ", $query);

//if query contains an underscore we assume user is searching for usernames
...
//if one word only, search for first OR lastnames
else{
